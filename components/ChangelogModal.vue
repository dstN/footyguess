      ...
      <div class="space-y-6 text-slate-200">
        ...
        <section>
          ...
          <ul class="list-inside list-disc space-y-2 text-sm text-slate-300">
            <li>
              <strong class="text-white">Keyboard Stability:</strong> Input now
              stays active while checking guesses, preventing the keyboard from
              hiding unnecessarily on mobile.
            </li>
            <li>
              <strong class="text-white">Scroll Fixes:</strong> Layout now
              adapts perfectly to mobile address bars (dvh), stopping random
              page jumps.
            </li>
          </ul>
        </section>
